...
// 系统常量定义
defined('THINK_PATH')   or define('THINK_PATH',     __DIR__.'/');  //当前文件目录
defined('APP_PATH')     or define('APP_PATH',       dirname($_SERVER['SCRIPT_FILENAME']).'/');  //$_SERVER['SCRIPT_FILENAME']执行脚本的绝对路径
